...
public class TriggerExample08 {
    public static void main(String[] args) throws Exception {
        ...
        stream.keyBy(r -> r.url).window(TumblingEventTimeWindows.of(Time.seconds(10))).trigger(new MyTrigger()).process(new WindowResult()).print();
        env.execute();
    }
