...
public class UvCountByWindowExample06 {

    /***
     * 窗口函数（Window Functions）-全窗口函数（full window functions）-处理窗口函数（ProcessWindowFunction）
     **
    ...
    public static void main(String[] args) throws Exception {
        ...
        stream.keyBy(data -> true).window(TumblingEventTimeWindows.of(Time.seconds(10))).process(new UvCountByWindow()).print();
        env.execute();
    }
