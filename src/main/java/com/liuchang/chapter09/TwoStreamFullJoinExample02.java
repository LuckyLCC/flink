...
/**
 * @Description: 按键分区状态（Keyed State）-列表状态（ListState）
 * <p>
...
public class TwoStreamFullJoinExample02 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple3<String, String, Long>> stream1 = env
                ...
                .assignTimestampsAndWatermarks(WatermarkStrategy.<Tuple3<String, String, Long>>forMonotonousTimestamps().withTimestampAssigner((SerializableTimestampAssigner<Tuple3<String, String, Long>>) (t, l) -> t.f2));
