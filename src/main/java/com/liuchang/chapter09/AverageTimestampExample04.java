...
public class AverageTimestampExample04 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        stream.keyBy(data -> data.user).flatMap(new AvgTsResult()).print();
        env.execute();
    }
    ...
    public static class AvgTsResult extends RichFlatMapFunction<Event, String> {
        ...
        public void open(Configuration parameters) throws Exception {
            avgTsAggState = getRuntimeContext().getAggregatingState(
                    new AggregatingStateDescriptor<>("avg-ts", new AggregateFunction<Event, Tuple2<Long, Long>, Long>() {
                @Override
