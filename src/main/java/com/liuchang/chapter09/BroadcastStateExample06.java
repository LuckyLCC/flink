...
/**
 * @Description: 算子状态（Operator State）-广播状态（BroadcastState）
 * @Author: liuchang
 * @CreateTime: 2022-07-18  15:33
 */
public class BroadcastStateExample06 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 将事件流和广播流连接起来，进行处理
        DataStream<Tuple2<String, Pattern>> matches = actionStream.keyBy(data -> data.userId).connect(bcPatterns).process(new PatternEvaluator());
        matches.print();
        env.execute();
    }
