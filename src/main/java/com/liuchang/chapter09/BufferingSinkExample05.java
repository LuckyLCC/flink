...
/**
 * @Description: 算子状态（Operator State）-列表状态（ListState）
 * @Author: liuchang
 * @CreateTime: 2022-07-18  15:21
 */
public class BufferingSinkExample05 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Event> stream = env
                ...
                .assignTimestampsAndWatermarks(WatermarkStrategy.<Event>forMonotonousTimestamps().withTimestampAssigner((SerializableTimestampAssigner<Event>) (element, recordTimestamp) -> element.timestamp)); stream.print("input");
        // 批量缓存输出
