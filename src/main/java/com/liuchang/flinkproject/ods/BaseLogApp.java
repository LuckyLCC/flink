package com.liuchang.flinkproject.ods;
...
public class BaseLogApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        pageDStream.addSink(MyKafkaUtil.getKafkaSink("dwd_page_log"));
        startDStream.addSink(MyKafkaUtil.getKafkaSink("dwd_start_log"));
        displayDStream.addSink(MyKafkaUtil.getKafkaSink("dwd_display_log"));
        //执行
